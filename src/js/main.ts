// 設定
class Config {
    static yasaiImgWidth: number;
    static yasaiImgHeigth: number;
    static fontHeigth: number;
    static stageCols: number;
    static stageRows: number;
    static stageBackgroundColor: string;
    static scoreBackgroundColor: string;
    static freeFallingSpeed: number;
    static eraseYasaiCount: number;
    static eraseAnimationDuration: number;
    static yasaiColors: number;
    static playerFallingSpeed: number;
    static playerDownSpeed: number;
    static playerGroundFrame: number;
    static playerMoveFrame: number;
    static playerRatateFrame: number;
    static zernkeshiDuration: number;
